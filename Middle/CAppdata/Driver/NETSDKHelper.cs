    ...
    public struct NETDEV_AUDIO_SAMPLE_PARAM_S
{
       ...
       public class NETDEVSDK
    {
       ...
       public  const int NETDEV_PEOPLE_CNT_MAX_NUM = 60;
        ...
        [DllImport(@"lib\msvcrt.dll", EntryPoint = "memcpy", CallingConvention = CallingConvention.Cdecl, SetLastError = false)]
        ...
        [DllImport(@"lib\NetDEVSDK.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(@"lib\kernel32.dll", CharSet = CharSet.Auto)]
